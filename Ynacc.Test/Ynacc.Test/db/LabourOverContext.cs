...
{
    public partial class LabourOverContext : DbContext
    {
        public LabourOverContext()
        {
        }

        public LabourOverContext(DbContextOptions<LabourOverContext> options)
            : base(options)
        {
        }

        public virtual DbSet<ImpWorkaddnight> ImpWorkaddnights { get; set; } = null!;
        public virtual DbSet<ImpLate04> ImpLate04s { get; set; } = null!;
        public virtual DbSet<audit04> audit04s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        {
            modelBuilder.Entity<ImpWorkaddnight>(entity =>
            {
                entity.HasKey(e => new { e.Deptid, e.Pid, e.Year, e.Month, e.Expyear, e.Expmonth });

                entity.ToTable("imp_workaddnight");
