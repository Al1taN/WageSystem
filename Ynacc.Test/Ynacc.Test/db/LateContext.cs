...
{
    public partial class LateContext : DbContext
    {
        public LateContext()
        {
        }

        public LateContext(DbContextOptions<LateContext> options)
            : base(options)
        {
        }

        public virtual DbSet<ImpOtherlate> ImpOtherlates { get; set; } = null!;
        public virtual DbSet<ImpLate> ImpLates { get; set; } = null!;
        public virtual DbSet<StaticsA> StaticsAs { get; set; } = null!;
