...
namespace Ynacc.Wage.Controllers
{
    ...
    [ApiController]
    public class StaticsBController : ControllerBase
    {
        private readonly LabourLateContext _context;

        public StaticsBController(LabourLateContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        //统计数据
        public async Task<ActionResult<List<Ynacc.Wage.Dal.StaticsB>>> GetWorkStaticsAttend([FromBody] JsonElement Data)
        {
            try
            {
