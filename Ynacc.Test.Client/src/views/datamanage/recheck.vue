<template>
  <div>
    ...
    <span class="time"><el-button @click="recheck">复核签字</el-button></span>
    <span class="time"><el-button @click="unrecheck">取消复核签字</el-button></span>
...
<script>
  ...
  methods:{
    ...
    recheck(){
      this.$axios({
              method: 'GET',
              url: 'http://localhost:5189/api/app/Recheck',
              params:{
                year:this.year,
                month:this.month,
                deptID:'16'
    ...
    unrecheck(){
      this.$axios({
              params: 'GET',
              url: 'http://localhost:5189/api/app/Unrecheck',
              params:{
                year:this.year,
                month:this.month,
                deptID:'16'
