<template>
    <div>
      ...
      <span class="time"><el-button v-loading="loading02" @click="recheck">审核签字</el-button></span>
      <span class="time"><el-button v-loading="loading03" @click="unrecheck">取消审核签字</el-button></span>
  ...
  <script>
    ...
    import {Audit,Audit02,Audit03,Audit04,Unaudit,Unaudit02,Unaudit03,Unaudit04} from '@/api/audit'
    export default {
        ...
        switch(this.value){
            case '新版员工考勤':{
              if(this.year != this.ddl01 || this.month != this.ddl02)
              {
                ...
                await Audit(item).then(err=>{console.log(err);})
              this.$message({
                message: '审核签字成功！',
                type: 'success'
              })
            ...
            case '新版早夜班加班':{
              if(this.year != this.ddl01 || this.month != this.ddl02)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Audit02(item).then(err=>{console.log(err);})
              this.$message({
                message: '审核签字成功！',
                type: 'success'
              })
            ...
            case '劳务制(新版)员工考勤':{
              if(this.year != this.ddl04 || this.month != this.ddl05)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Audit03(item).then(err=>{console.log(err);})
              this.$message({
                message: '审核签字成功！',
                type: 'success'
              })
            ...
            case '劳务制(新版)早夜班加班':{
              if(this.year != this.ddl04 || this.month != this.ddl05)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Audit04(item).then(err=>{console.log(err);})
              this.$message({
                message: '审核签字成功！',
                type: 'success'
              })
        ...
        switch(this.value){
            case '新版员工考勤':{
              if(this.year != this.ddl01 || this.month != this.ddl02)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Unaudit(item).then(err=>{console.log(err);})
              this.$message({
                message: '取消审核签字成功！',
                type: 'success'
              })
            ...
            case '新版早夜班加班':{
              if(this.year != this.ddl01 || this.month != this.ddl02)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Unaudit02(item).then(err=>{console.log(err);})
              this.$message({
                message: '取消审核签字成功！',
                type: 'success'
              })
            ...
            case '劳务制(新版)员工考勤':{
              if(this.year != this.ddl04 || this.month != this.ddl05)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Unaudit03(item).then(err=>{console.log(err);})
              this.$message({
                message: '取消审核签字成功！',
                type: 'success'
              })
            ...
            case '劳务制(新版)早夜班加班':{
              if(this.year != this.ddl04 || this.month != this.ddl05)
              {
                ...
                item["Year"] = this.year
                item["Month"] = this.month
                await Unaudit04(item).then(err=>{console.log(err);})
              this.$message({
                message: '取消审核签字成功！',
                type: 'success'
              })
